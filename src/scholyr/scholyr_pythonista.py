...
class Managyr:
    def __init__(self, record_file='record.json', schedule_file='schedule.json', gradebook_dir='gradebooks/'):
...
class ManagyrApp:
    def __init__(self, manager):
        ...
        self.build_ui()
        self.tab_changed(self.tab_view)  # Ensure initial data loading based on the selected tab
    ...
    def build_ui(self):
        ...
        for field, label, top in fields:
            setattr(self, f'{field}_label', ui.Label(frame=(10, top, 100, 32), text=label, text_color=border_color, font=label_font))
            setattr(self, f'{field}_entry', ui.TextField(frame=(110, top, 300, 32), bg_color='#000000', text_color=text_color, font=text_font))
        ...
        self.preview_pane = ui.TextView(frame=(10, 136, 400, 344), bg_color='#000000', text_color=border_color, font=text_font)
        ...
        self.refresh_button = ui.Button(frame=(10, 490, 130, 32), title='Refresh', bg_color='#222222', tint_color=border_color, font=button_font)
        ...
        self.save_button = ui.Button(frame=(150, 490, 130, 32), title='Save', bg_color='#222222', tint_color=border_color, font=button_font)
        ...
        self.exit_button = ui.Button(frame=(290, 490, 130, 32), title='Exit', bg_color='#222222', tint_color=border_color, font=button_font)
        ...
        for field, label, top in schedule_fields:
            setattr(self, f'{field}_label', ui.Label(frame=(10, top, 150, 32), text=label, text_color=border_color, font=label_font))
            setattr(self, f'{field}_entry', ui.TextField(frame=(160, top, 250, 32), bg_color='#000000', text_color=text_color, font=text_font))
            getattr(self, f'{field}_entry').border_width = 1
            getattr(self, f'{field}_entry').border_color = border_color
            self.schedule_view.add_subview(getattr(self, f'{field}_label'))
            self.schedule_view.add_subview(getattr(self, f'{field}_entry'))

        self.add_class_button = ui.Button(frame=(10, 600, 130, 32), title='Add Class', bg_color='#222222', tint_color=border_color, font=button_font)
        ...
        self.remove_class_button = ui.Button(frame=(150, 600, 130, 32), title='Remove Class', bg_color='#222222', tint_color=border_color, font=button_font)
        ...
        self.exit_button_schedule = ui.Button(frame=(290, 600, 130, 32), title='Exit', bg_color='#222222', tint_color=border_color, font=button_font)
        ...
        self.assignments_table = ui.TableView(frame=(10, 220, 400, 260))  # Height reduced from 310 to 260
        ...
        self.add_assignment_button = ui.Button(frame=(10, 490, 150, 32), title='Add Assignment', bg_color='#222222', tint_color='#FFDE98', font=('Menlo', 14))
        ...
        self.remove_assignment_button = ui.Button(frame=(170, 490, 150, 32), title='Remove Assignment', bg_color='#222222', tint_color='#FFDE98', font=('Menlo', 14))
        ...
        # Exit button
        self.exit_button_gradebook = ui.Button(frame=(330, 490, 80, 32), title='Exit', bg_color='#222222', tint_color='#FFDE98', font=('Menlo', 14))
    ...
    def remove_class(self, sender):
        selected_row = self.schedule_list.selected_row[1] if self.schedule_list.selected_row else -1
        if selected_row >= 0:
    ...
    def update_schedule_list(self):
        ...
        items = [f"{item['course_code']} - {item['section']} - {item['course_title']}" for item in schedule]
        self.schedule_list.data_source.items = items
        self.schedule_list.reload()

    def populate_gradebook_list(self):
        gradebook_titles = [course['course_title'] for course in self.manager.get_schedule()]
        self.gradebook_list.data_source.items = gradebook_titles
        self.gradebook_list.reload()

    def add_assignment(self, sender):
        course_title = self.gradebook_list.data_source.items[self.gradebook_list.selected_row[1]] if self.gradebook_list.selected_row else None
        if course_title:
    ...
    def remove_assignment(self, sender):
        ...
        if course_title:
            ...
            if selected_rows:
                ...
                gradebook = [grade for i, grade in enumerate(gradebook) if i not in selected_rows]
    ...
    def populate_gradebook(self, course_title):
        gradebook = self.manager.get_gradebook(course_title)
        items = [f"{assignment['name']} - {assignment['points_possible']} - {assignment['points_actual']} - {assignment['grade_percent']:.2f}%" for assignment in gradebook]
    ...
    def gradebook_selected(self, sender):
        selected_row = self.gradebook_list.selected_row[1] if self.gradebook_list.selected_row else -1
        if selected_row >= 0:
    ...
    def show_add_assignment_dialog(self, course_title):
        ...
        name_field = ui.TextField(frame=(10, 10, 280, 32), placeholder='Assignment Name', bg_color='#000000', text_color='#000000', font=('Menlo', 14), border_width=1, border_color='#FFDE98')
        points_possible_field = ui.TextField(frame=(10, 52, 280, 32), placeholder='Points Possible', bg_color='#000000', text_color='#000000', font=('Menlo', 14), border_width=1, border_color='#FFDE98')
        points_actual_field = ui.TextField(frame=(10, 94, 280, 32), placeholder='Points Actual', bg_color='#000000', text_color='#000000', font=('Menlo', 14), border_width=1, border_color='#FFDE98')

        add_button = ui.Button(frame=(10, 136, 130, 32), title='Add', action=dialog_action, bg_color='#222222', tint_color='#FFDE98', font=('Menlo', 14))
        add_button.border_width = 1
        add_button.border_color = '#FFDE98'
        cancel_button = ui.Button(frame=(160, 136, 130, 32), title='Cancel', action=lambda x: dialog.close(), bg_color='#222222', tint_color='#FFDE98', font=('Menlo', 14))
